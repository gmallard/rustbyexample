...
the functionality via one of the traits: Fn, FnMut, or FnOnce for this unknown 
type. This type is assigned to the variable which is stored until calling.
...
and not be allowed. Thus, bounding by one of the traits: Fn, FnMut, or FnOnce 
